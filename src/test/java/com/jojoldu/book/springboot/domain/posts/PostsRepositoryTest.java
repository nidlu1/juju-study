...
public class PostsRepositoryTest {
    ...
    @After //JUnit에서 단위 테스트가 끝날 때마다 수행되는 메소드를 지정. 보통 배포전 전체 테스트를 수행시 테스트간 데이터침범을 막기 위해 사용. 여러 테스트가 동시에 수행시 테스트용 db인 H2에 데이터가 남아 있어 다음 테스트 실행시 테스트 실패 가능성.
    public void cleanup(){
